...
async def chunk(filename, binary=None, from_page=0, to_page=10000000000, lang="Chinese", callback=None, **kwargs):
    """
    ...
    for df in dfs:
        ...
        await KBService.update_parser_config(kwargs["kb_id"], {"field_map": {k: v for k, v in clmns_map}})
    callback(0.35, "")
...
if __name__ == "__main__":
    ...
    asyncio.run(chunk(sys.argv[1], callback=dummy))
