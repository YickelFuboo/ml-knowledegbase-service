...
import trio
from .graph_extractor import GraphExtractor as GeneralKGExt
from .community_reports_extractor import CommunityReportsExtractor
from .extractor import Extractor
from ..entity_resolution import EntityResolution
from ..light.graph_extractor import GraphExtractor as LightKGExt
from ..utils import (
    graph_merge,
    get_graph,
    set_graph,
...
async def run_graphrag(
    ...
    chunks = []
    for d in await RETRIEVALER.chunk_list(
...
async def generate_subgraph(
    ...
    cid = chunk_id(chunk)
    await DOC_STORE_CONN.delete({"knowledge_graph_kwd": "subgraph", "source_id": doc_id}, tenant_id, kb_id)
    await DOC_STORE_CONN.insert([{"id": cid, **chunk}], tenant_id, kb_id)
